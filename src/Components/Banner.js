...
import TerraMainImage from "../asset/firstimage.webp"
import TerraTwoImage from "../asset/gym.webp"
import TerraOneImage from "../asset/terrace.webp"
import TerraThreeImage from "../asset/toilet.webp"
...
const Banner = () => {
  ...
  return (
    ...
    <div>
      ...
      <h1 className='font-[NeueBold] text-[2rem]   uppercase pr-3 lg:pr-8 border-r-[2px] border-gray-300  lg:text-[4rem]' >Hamlet</h1>
      <h3 className='font-[NeueMedium] lg:text-[1.5rem] lg:mt-2 flex items-center justify-start gap-2 lg:gap-3  text-[0.8rem]' ><HiOutlineLocationMarker className='lg:text-[1.8rem] mb-1 text-[1.2rem] ' /> Baner, Pune</h3>
      </div>
