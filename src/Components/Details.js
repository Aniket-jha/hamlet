...
const Details = ({propertyDetail}) => {
  ...
  return (
    ...
    <div id="details" className='lg:mx-16 items-center mx-4 py-4 lg:pt-12 lg:pb-12 grid grid-cols-1 gap-x-6 lg:gap-12 lg:grid-cols-2 grid-flow-row  '>
      ...
      <h3 className='font-[NeueMedium]  lg:text-[1.5rem]  text-[.8rem] ' >Where Modern Living Meets Vibrant Community Life</h3>
        
        <h1 className='font-[NeueBold]  text-[1.5rem] leading-[1.5rem] lg:leading-[3.5rem]  uppercase lg:text-[2.5rem]' >Discover Comfort and Community at Pune's Premier Coliving Space</h1>
        <p className='font-[NeueRegular]  text-[0.8rem]  lg:text-[1.1rem] ' > Experience the perfect blend of comfort and community at Pune's premier coliving space. Enjoy modern amenities, vibrant social events, and a convenient location, all designed to enhance your living experience. Join us today!</p>
