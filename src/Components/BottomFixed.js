  ...
  return (
    ...
    <div>
        ...
        <div className='flex items-center gap-2 lg:gap-12 justify-center' >
            ...
            <a target='_blank' rel='noreferrer' href="https://firebasestorage.googleapis.com/v0/b/union-living.appspot.com/o/files%2FHamlet%20by%20Union%20Co-living%20Brochure.pdf?alt=media&token=6df42bcd-4d50-4d2c-baf3-14d2e0166d81" download> <button className="uppercase flex items-center justify-center gap-2 lg:gap-3 rounded-lg shadow-md  font-[NeueMedium] ease-in duration-300 w-[155px] lg:w-[280px]  text-[10px] md:text-[16px]  hover:shadow-none hover:bg-[#272727] tracking-wider py-[8px] px-[6px] mt-3 md:py-[12px] md:px-[24px] text-[#FFFEFC] bg-[#D64C27]" > <MdOutlineFileDownload className="text-[1rem] lg:text-[1.5rem]" /> Download Brochure  </button></a>
