...
import TerraceImage2 from "../asset/terraceImage2.png"
import TerraceImage from "../asset/terraceImage.png"
...
import ComImage1 from "../asset/comImage1.jpg"
import ComImage2 from "../asset/comImage2.png"
const ImageSection = () => {
  return (
          ...
          <div>
            ...
            <div className='lg:grid lg:my-12 mb-3  gap-12 grid-cols-5 grid-flow-col' >
              ...
              <div className='col-span-3 flex items-center justify-end' >
                <img className=' my-3 lg:my-0' src={TerraceImage2} />
              </div>
            </div>
            <div className='lg:grid lg:my-12 mb-3  gap-12 grid-cols-5 grid-flow-col' >
              <div className='col-span-2 flex items-center justify-end' >
                <img className='w-[600px] my-3 lg:my-0' src={ComImage1} />
              </div>
              <div className='col-span-3 flex items-center justify-end' >
                <img className=' my-3 lg:my-0' src={ComImage2} />
              </div>
            </div>
